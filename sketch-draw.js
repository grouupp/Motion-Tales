...
function sketchDraw(p) {
  ...
  let paragraph =
    "A fairy godmother transformed pumpkins and mice into a shining carriage.";
  ...
  p.setup = function () {
    ...
    // Load HandPose AFTER video exists
    handPose = ml5.handPose(
      { flipped: true },
      () => {
        console.log("HandPose ready");

        handPose.detectStart(video, (r) => {
          hands = r;
        });
      }
    );
